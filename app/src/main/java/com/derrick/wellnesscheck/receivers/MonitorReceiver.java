package com.derrick.wellnesscheck.receivers;
...
import com.derrick.wellnesscheck.services.FallDetectionService;
import com.derrick.wellnesscheck.services.RingAlarmService;
...
import com.derrick.wellnesscheck.ui.activities.CheckInActivity;
...
public class MonitorReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (intent.getAction()){
            case ACTION_NOTIFY:
                nextCheckIn = App.getNextCheckIn();

                //next check-in
                App.setAlarm(context, nextCheckIn, ACTION_NOTIFY);
                //send sms
                long smsAlarmTime = System.currentTimeMillis() + Prefs.respondMinutes() * MINUTE_IN_MILLIS;
                App.setAlarm(context, smsAlarmTime, ACTION_SEND_SMS);
            ...
            case ACTION_DELETE:
                ...
                App.cancelAlarm(context, ACTION_NOTIFY);
                App.cancelAlarm(context, ACTION_SEND_SMS);
                break;
        }
    }
